        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="//suite.social/business/user/plans" target="_top">View all</a></li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="//suite.social/business/user/plans" target="_top"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
		<li><a href="//suite.social/business/user/plans" target="_top"><i class="fas fa-gift"></i> <span>Promotion</span></a></li>	
		<li><a hhref="//suite.social/business/user/plans" target="_top"><i class="fas fa-users"></i> <span>Users</span></a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-primary">
            ...
            <a href="//suite.social/business/user/plans" target="_top" class="small-box-footer">View users <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-primary">
            ...
            <a href="//suite.social/business/user/plans" target="_top" class="small-box-footer">Create Promo <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">

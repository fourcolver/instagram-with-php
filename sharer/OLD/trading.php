<?php
    ...
    $data=array(
    '0'=>array("id"=>"3","visitor_target"=>"100","url"=>"","theme"=>"","ip"=>"1","reset"=>"1"), // visitor_target same as discount price
    );
...
$website = 'https://suite.social/personal/trading';	
	
/// DISCOUNT	
$image = 'https://suite.social/images/mockup/trading.jpg';	
$headline = 'Get €100 real money to trade in price prediction games!';
$caption = 'The more you share, the cheaper the discount - Refer friends on social media to claim this offer.';
...
$price = '100';	// How much the original price was.

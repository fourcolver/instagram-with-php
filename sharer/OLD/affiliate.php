<?php
    ...
    $data=array(
    '0'=>array("id"=>"2","visitor_target"=>"99","url"=>"","theme"=>"","ip"=>"1","reset"=>"1"), // visitor_target same as discount price
    );
...
$headline = '50% off Social Suite & earn €100 per signup as an affiliate!';
$caption = 'Only 10 subscribers earns you €1000! Refer friends now on social media to claim this offer.';

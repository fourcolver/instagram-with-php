...
/// DISCOUNT	
$image = '//suite.social/images/industry/Tradesperson.jpg';	
$headline = 'Promotion for your trade service';
        ...
        Tick.count.schedule('every last day of the month at 12:00').onupdate = function(value) {
            ...
            <div class="social-buttons">
                <a style="padding-top:20px; padding-bottom:20px" href="#Share" data-toggle="modal" class="btn btn-block btn-social btn-<?php echo $network; ?>">
                    <i style="padding-top:20px; padding-bottom:20px" class="fas fa-share-alt fa-5x"></i> <h1 id="share">Refer friends & family!</h1>					
                </a>				
            </div>	

<?php
    ...
    $data=array(
    '0'=>array("id"=>"1","visitor_target"=>"50","url"=>"","theme"=>"","ip"=>"1","reset"=>"1"), // visitor_target same as discount price
    );
...
/// DISCOUNT	
$image = '//suite.social/images/industry/Dentist.jpg';	
$headline = 'Discount on dental treatment';
$caption = 'The more you share, the cheaper you book!';
$link = 'https://YourPaymentLink.com';	
$currency = '$'; // The currency symbol.
$price = '150';	// How much the original price was.
$discount = '50'; // How much they can buy at.

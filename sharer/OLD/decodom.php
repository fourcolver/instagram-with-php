<?php
    ...
    $data=array(
    '0'=>array("id"=>"1","visitor_target"=>"100","url"=>"","theme"=>"","ip"=>"1","reset"=>"1"), // visitor_target same as discount price
    );
...
/// GENERAL	
$logo = 'https://ascefiu.files.wordpress.com/2016/05/pure-safari-your-logo-here.jpg';	
$website = 'https://www.facebook.com/paintersdecodom/';	
	
/// DISCOUNT	
$image = 'https://scontent-lht6-1.xx.fbcdn.net/v/t31.0-8/11741121_1640353929538806_434652843071847407_o.jpg?_nc_cat=104&_nc_ht=scontent-lht6-1.xx&oh=f50aa9d3e8bf63668d65d717ef90c23e&oe=5D7D9B0A';	
$headline = 'Dusam, your promotion goes here!';
$caption = 'The more they refer, the cheaper they book! Or you can offer any kind of promotion you want. This will help you turn your clients and website visitors into your personal viral marketing team who constantly refer there friends & family to your services.';
$link = 'https://YourPaymentLink.com';	
$currency = '$'; // The currency symbol.
$price = '500';	// How much the original price was.
$discount = '100'; // How much they can buy at.
        ...
        <!-- ./col -->
            ...
            <!-- /.box-header --> 
                    ...
                    <div class="box-body">
						...
						<h2>1. Refer friends & family</h2>
						<p>To reduce price, refer friends & family on social, email or SMS.</p>
        ...
        Tick.count.schedule('every last day of the month at 12:00').onupdate = function(value) {
            ...
            <div class="social-buttons">
                <a style="padding-top:20px; padding-bottom:20px" href="#Share" data-toggle="modal" class="btn btn-block btn-social btn-<?php echo $network; ?>">
                    <i style="padding-top:20px; padding-bottom:20px" class="fas fa-share-alt fa-5x"></i> <h1 id="share">Refer with friends & family!</h1>					
                </a>				
            </div>	

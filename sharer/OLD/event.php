<?php
    ...
    $data=array(
    '0'=>array("id"=>"1","visitor_target"=>"25","url"=>"","theme"=>"","ip"=>"1","reset"=>"1"), // visitor_target same as discount price
    );
...
/// DISCOUNT	
$image = '//suite.social/images/industry/Events.jpg';	
$headline = 'Discount on entry tickets';
$caption = 'The more you share, the cheaper you pay!';
$link = 'https://YourPaymentLink.com';	
$currency = '$'; // The currency symbol.
$price = '50';	// How much the original price was.
$discount = '25'; // How much they can buy at.

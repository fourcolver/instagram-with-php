<?php
    ...
    $data=array(
    '0'=>array("id"=>"3","visitor_target"=>"49","url"=>"","theme"=>"","ip"=>"1","reset"=>"1"), // visitor_target same as discount price
    );
...
/// DISCOUNT	
$image = 'https://suite.social/images/mockup/sharer2.jpg';	
$headline = 'Free Social Promotion Script!';
$caption = 'Refer friends on social media to claim this offer.';
$link = 'https://api.whatsapp.com/send?phone=447876806121&text=I%20want%20to%20get%20free%20social%20sharer%20script';	
$currency = '€'; // The currency symbol.
$price = '49';	// How much the original price was.
$discount = '49'; // How much they can buy at.
        ...
        <!-- ./col -->
            ...
            <!-- /.box-header --> 
                    ...
                    <div class="box-body">
						...
						<h2>1. Refer friends</h2>
						<p>To reduce price, refer friends on social, email or SMS.</p>
						<h2>2. Check discount daily</h2>
...
<div class="box text-center">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Hi valued customer! Thanks for using our services.</h3>
...
<h4 class="text-center">LIKE OR FOLLOW</h4>

<iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Ffacebook.com%2F<?php echo $facebook; ?>&width=63&layout=button&action=like&size=large&show_faces=true&share=false&height=65&appId=1382960475264672" width="63" height="30" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
<a href="https://twitter.com/<?php echo $twitter; ?>?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-screen-name="false" data-size="large" data-show-count="false">Follow @<?php echo $twitter; ?></a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
<div class="g-ytsubscribe" data-channelid="<?php echo $youtube; ?>" data-layout="default" data-count="hidden"></div><br>
<iframe class="btnt" frameborder="0" border="0" scrolling="no" allowtransparency="true" height="20" width="70" src="https://platform.tumblr.com/v2/follow_button.html?type=follow&amp;tumblelog=<?php echo $tumblr; ?>&amp;color=blue"></iframe>
<a data-pin-do="buttonFollow" href="https://www.pinterest.com/<?php echo $pinterest; ?>">Follow</a>
<script type="IN/FollowCompany" data-id="<?php echo $linkedin; ?>"></script>
...
<!-- =================MODAL====================== -->
	...
	<h3>Share your referral link on Instagram, Messenger, Snapchat, WeChat or YouTube</h3>

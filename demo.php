      ...
      <div class="row">
        ...
        <section class="col-lg-6 col-md-6">
          	<div class="box box-success">
	            ...
	            <!-- /.box-header -->
	            <!-- form start -->
	            <form name="socialWall" id="socialWall" method="post" action="" enctype="multipart/form-data">
	                <div class="box-body">
			          <div class="form-group">
						...
						echo '<h4>Logo</h4>';
						echo '<span class="text-muted">Enter logo URL (TIP: if paste in URL, click spacebar to see live preview).</span>';
						...
						echo '<div class="form-group">';
						echo '<h4>Banner</h4>';
						echo '<span class="text-muted">Enter Banner URL (TIP: if paste in URL, click spacebar to see live preview).</span>';
	                	...
	                	<div class="form-group">
		                  <h4>Headline</h4>
						  <span class="text-muted">Enter your promotional headline (e.g. 30% off coupon).</span>
						  <p><input type="text" name="headline" class="form-control headlineinput" id="headline" placeholder="Enter Headline"></p>				  
		                </div>
					
		                <div class="form-group">
		                  <h4>Caption</h4>
						  <span class="text-muted">Explain what user must to do to claim.</span>
		                ...
		                <div class="form-group">
		                  <h4>Button CTA</h4>
						  <span class="text-muted">Enter button call to action (e.g. Claim, Download etc).</span>
						  <p><input type="text" name="cta" id="cta" class="form-control actioninput" placeholder="Claim"></p>				  
		                </div>				
						
		                <div class="form-group">
		                  <h4>Share URL</h4>
						  <span class="text-muted">Enter the URL users will share.</span>
						  <p><input type="url" name="share" id="share" class="form-control" placeholder="Enter Share URL"></p>
		                </div>				
					
		                <div class="form-group">
		                  <h4>Promo URL</h4>
						  <span class="text-muted">Enter url the user will be redirected to after they share (TIP: This can be url of your shopping cart, coupon <a style="color:#609450" href="plugins.php">or plugins</a>).</span>
						  <p><input type="url" name="promo" id="promo" class="form-control" placeholder="Enter Promo URL"></p>
		                </div>

		                <div class="form-group">
		                  <h4>Website Link</h4>
						  <span class="text-muted">Enter Website Link.</span>
	              	...
	              	<!-- /.box-body -->
		              		...
		              		<p><a href="https://suite.social/business/user/plans" target="_top" class="btn btn-lg btn-block btn-danger">UPGRADE TO CREATE <i class="fas fa-credit-card"></i></a></p>
		        </form>
				                	...
				                	foreach ($promotion as $key => $value) {
				                		if($_SESSION['dashboard_uid'] == $value['UserID']){
								            ...
								            <tr>
								        		...
								        		<td><b>Share URL</b><br><?php echo $value['share']; ?><br><br><b> Offer URL</b><br><?php echo $value['offerurl']; ?><br><br><b> Promo URL</b><br><?php echo $value['promo']; ?></td>
								        		<!--<td><input class="form-control" value="<?php //echo $value['promo']; ?>" placeholder="Promo URL"></td>-->
								                <td>
								                	<?php if(!empty($value['FacebookUrl'])){ ?>
								                		<a href="<?php echo $value['FacebookUrl']; ?>"><i class="fab fa-2x fa-facebook"></i>&nbsp;&nbsp; </a>
								                	<?php } ?>
								                	<?php if(!empty($value['TwitterUrl'])){ ?>
								                		<a href="<?php echo $value['TwitterUrl']; ?>"><i class="fab fa-2x fa-twitter"></i>&nbsp;&nbsp; </a>
								                	<?php } ?>
								                	<?php if(!empty($value['YouTubeUrl'])){ ?>
								                		<a href="<?php echo $value['YouTubeUrl']; ?>"><i class="fab fa-2x fa-youtube"></i> </a>
								                	<?php } ?>
								                </td>               
								                <td>
								                    <div class="btn-group-vertical">
